...
class Restaurant_Cafeteria_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function restaurant_cafeteria_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function restaurant_cafeteria_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function restaurant_cafeteria_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function restaurant_cafeteria_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->restaurant_cafeteria_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function restaurant_cafeteria_load( $class ) {
