...
if ( ! function_exists( 'restaurant_culinary_sanitize_select' ) ) :
    ...
    function restaurant_culinary_sanitize_select( $restaurant_culinary_input, $restaurant_culinary_setting ) {
        ...
        $choices = $restaurant_culinary_setting->manager->get_control( $restaurant_culinary_setting->id )->choices;
        return ( array_key_exists( $restaurant_culinary_input, $choices ) ? $restaurant_culinary_input : $restaurant_culinary_setting->default );
    }

endif;

/*Radio Button sanitization*/
function restaurant_culinary_sanitize_choices( $input, $setting ) {
    global $wp_customize;
