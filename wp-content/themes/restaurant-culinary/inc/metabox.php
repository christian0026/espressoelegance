...
function restaurant_culinary_custom_create_term_callback($term_id) {
    // add term meta data
    add_term_meta(
        $term_id,
        'term_image',
...
function restaurant_culinary_category_edit_form_fields_callback($ttObj, $taxonomy) {
    ...
    $restaurant_culinary_image = get_term_meta( $term_id, 'term_image', true ); ?>
...
function restaurant_culinary_edit_term_callback($term_id) {
    $restaurant_culinary_image = '';
    $restaurant_culinary_image = get_term_meta( $term_id, 'term_image' );
