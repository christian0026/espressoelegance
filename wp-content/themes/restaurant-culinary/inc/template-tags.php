...
if( !function_exists('restaurant_culinary_site_logo') ):
     ...
     */
    function restaurant_culinary_site_logo( $args = array(), $echo = true ){
         ...
         */
        $args = apply_filters('restaurant_culinary_site_logo_args', $args, $defaults);
        if ( has_custom_logo() ) {
         ...
         */
        $html = apply_filters('restaurant_culinary_site_logo', $html, $args, $classname, $contents);
        if (!$echo) {
            return $html;
        }
...
if( !function_exists('restaurant_culinary_site_description') ):
     ...
     */
    function restaurant_culinary_site_description($echo = true){
         ...
         *
         */
        $html = apply_filters('restaurant_culinary_site_description', $html, $description, $wrapper);
        if (!$echo) {
            return $html;
        }
        echo $html; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
...
if( !function_exists('restaurant_culinary_posted_on') ):
     ...
     */
    function restaurant_culinary_posted_on( $icon = true, $animation_class = '' ){
...
if( !function_exists('restaurant_culinary_posted_by') ) :
     ...
     */
    function restaurant_culinary_posted_by( $icon = true, $animation_class = '' ){   
...
if( !function_exists('restaurant_culinary_posted_by_avatar') ) :
     ...
     * Prints HTML with meta information for the current author.
     */
    function restaurant_culinary_posted_by_avatar( $date = false ){
        ...
        if( $restaurant_culinary_post_author ){
            ...
            if( $date ){
                restaurant_culinary_posted_on($icon = false);
            }
            echo '</div>';
...
if( !function_exists('restaurant_culinary_entry_footer') ):
     ...
     */
    function restaurant_culinary_entry_footer( $cats = true, $tags = true, $edits = true){   
        ...
        if ('post' === get_post_type()) {
            ...
            if( $cats && $restaurant_culinary_post_category ){
            ...
            if( $tags && $restaurant_culinary_post_tags ){
                /* translators: used between list items, there is a space after the comma */
                $tags_list = get_the_tag_list('', esc_html_x(', ', 'list item separator', 'restaurant-culinary'));
                if( $tags_list ){
...
if( !function_exists('restaurant_culinary_is_comment_by_post_author') ):
     ...
     * @return bool
     */
    function restaurant_culinary_is_comment_by_post_author($comment = null){
...
if( !function_exists('restaurant_culinary_breadcrumb') ) :
     ...
     */
    function restaurant_culinary_breadcrumb($comment = null){
